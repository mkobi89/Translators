...
filename1<-"//130.60.235.127/Daten/CLINT/04_Auswertungen/Translators/contQuest.png"
png(filename1,pointsize = 20,width=1000, height=600,units = "px")
...
mtext(side=2,"Mean Correct", line=3, font =1, cex=1.2)
