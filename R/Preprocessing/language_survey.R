...
Dol_select$Prozent_cumth_Life <-
  (Dol_select$cum_trainingh_DuU / (age * 52 * 16 * 7)) * 100
...
remove(age, Dol_def, Dol_select,Musik_def, Musik_select, Pers_def,Pers_select,Sprachen_def, Sprachen_select, cum_trainingh_Musik,cum_trainingh_DuU)
